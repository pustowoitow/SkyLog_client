...
class LoginActivity : AppCompatActivity(){
    ...
    fun Next_Activity()
    {
        val intent = Intent(this, BlocksListActivity::class.java)
    ...
    private fun publishMqtt() {
        val topic2: String = My_MQTT_info.BlocksNames[0] + "/cmd/dfjid"
        // if (My_MQTT_info.Connection_status==true)
        mqttHelper!!.publishMessage("1", 0, topic2)  //посылаем неизвестyю команду для получения ответа
    }
